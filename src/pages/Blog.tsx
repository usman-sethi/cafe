        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              ...
              <p className="text-coffee-600 max-w-xl text-lg">
            ...
            <div className="mb-16">
              ...
              <article className="bg-white rounded-3xl overflow-hidden shadow-md flex flex-col lg:flex-row border border-coffee-100/50">
                ...
                <div className="lg:w-2/5 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                  <div className="flex items-center text-sm text-coffee-500 font-mono mb-4 space-x-4">
                  ...
                  <p className="text-coffee-600 mb-8 text-lg leading-relaxed">{featuredPost.excerpt}</p>
            ...
            {filteredPosts.map((post) => (
              <article key={post.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-coffee-100/50 flex flex-col group">
                ...
                <div className="p-8 flex flex-col flex-grow">
                  <div className="flex justify-between items-center text-sm text-coffee-500 mb-3 font-mono">
                    <span>{post.date}</span>
                  ...
                  <p className="text-coffee-600 mb-6 flex-grow">{post.excerpt}</p>
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-20">
              <p className="text-coffee-500 text-lg">No articles found matching your search.</p>
            </div>
          )}
        </div>
      </main>
